...
@section('head',"Tìm kiếm")
@section('head-search',$search)
                            ...
                            <div class="product__item">
                                ...
                                <div class="product__item__pic set-bg" data-setbg="{{asset($product->product_image)}}">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="{{route("addToCart",$product->id)}}" data-price="{{$product->product_price}}" class="addCart"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
