...
@section('content')
    ...
    <form action="{{ route('blog.update',$blog->id) }}" method="post" name="blog" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        ...
        <img src="{{ str_replace("public/","/storage/",$blog->thumbnail) }}" alt="" srcset="">
        @error('blog_image')
            <div class="text-dange">{{ $message }}</div>
        @enderror
    </div>
